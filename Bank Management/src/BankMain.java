...
public class BankMain extends JFrame{
	...
	public static void main(String[] args) {
		...
		final JFrame SRBM = new JFrame("SR Bank Record Manager");
		...
		Crac.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				final JFrame signup = new JFrame("Sign Up");
		...
		final JFrame BB = new JFrame("SR Bank Record Manager");
		BB.setSize(470,400);
		...
		login.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				JPanel upass = new JPanel();
				upass.add(new JLabel("Password:"));
				final JPasswordField uPass = new JPasswordField(15);
				upass.add(uPass);
				Login.add(upass);
				...
				lgin.addActionListener(new ActionListener(){
					...
					public void actionPerformed(ActionEvent e) {
						...
						String password = uPass.getText();
						File file = new File("C:\\Users\\Milon Hossain\\Documents\\Bank Management\\src\\ClientData.txt");
		...
		we.setText("About");
		we.setFont(new Font("Times New Roman", 1, 19));
		we.setPreferredSize(new Dimension(200, 80));
